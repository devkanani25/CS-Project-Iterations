...
window.title("Image Editor v1.91")#title for the application window
...
resetButton = Button(window,text="Reset",width=6,command=reset_image,bg="gray25",fg="white").grid(row=9,column=3,padx=5)
